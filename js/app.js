(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper-main__slider")) new swiper_core_Swiper(".swiper-main__slider", {
        ...
        if (document.querySelector(".catalog-tovar-main__slider")) new swiper_core_Swiper(".catalog-tovar-main__slider", {
        ...
        if (document.querySelector(".clients-main__slider")) new swiper_core_Swiper(".clients-main__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
